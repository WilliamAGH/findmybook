 ...
 *   429 from Google, the breaker opens for the remainder of the Pacific Time day so we immediately stop
 ...
 *   unauthenticated call until the next Pacific Time reset via {@link #isFallbackAllowed()}.</li>
 * </ul>
 *
 * <p>Both guards reset automatically at Pacific Time midnight and can be inspected or reset manually from
