...
enum AiErrorCode {
    ...
    LOCAL_RATE_LIMITED("local_rate_limited", "Book description enrichment is temporarily rate limited", true),
    LOCAL_CIRCUIT_OPEN("local_circuit_open", "Book description enrichment is temporarily unavailable", true),
