...
| `make backfill-ai-seo` | Run AI summary + SEO metadata backfill for books missing current SEO rows or holding deterministic fallback rows (description length must be >= 50) |
